...
var datas: [String](count:5; repeatedValue:"")
...
//
//
//func say( message message: String,
//          counter: Int) -> (String, String) {
//    return ("Say \(message)", "ss")
//}
//
//let (result, _) = say(message: "somkiat", counter: 5)
//print(result)
//
//
//func say2(names: String...) -> Void {
//    for name in names {
//        print(name)
//    }
//}
